...
TYPE_TAG_MAPPING = {
    "PER": ("[unused3]", "[unused4]"),
    "PERSON": ("[unused3]", "[unused4]"),
    "ORG": ("[unused5]", "[unused6]"),
    "LOC": ("[unused7]", "[unused8]"),
    "GPE": ("[unused9]", "[unused10]"),
    "DATE": ("[unused11]", "[unused12]"),
    "EVENT": ("[unused13]", "[unused14]"),
    "ORDINAL": ("[unused15]", "[unused16]"),
    "WORK_OF_ART": ("[unused17]", "[unused18]"),
    "NORP": ("[unused19]", "[unused20]"),
    "CARDINAL": ("[unused21]", "[unused22]"),
    "FAC": ("[unused23]", "[unused24]"),
    "PRODUCT": ("[unused25]", "[unused26]"),
    "TIME": ("[unused27]", "[unused28]"),
    "LAW": ("[unused29]", "[unused30]"),
    "LANGUAGE": ("[unused31]", "[unused32]"),
    "PERCENT": ("[unused33]", "[unused34]"),
    "MONEY": ("[unused35]", "[unused36]"),
    "QUANTITY": ("[unused37]", "[unused38]"),
    "SEP": ("[SEP]", "[SEP]")
}
